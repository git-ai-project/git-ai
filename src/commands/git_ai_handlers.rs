...
fn print_help() {
    ...
    eprintln!(
        "    Presets: claude, codex, continue-cli, cursor, gemini, github-copilot, amp, augment, windsurf, opencode, pi, ai_tab, firebender, human, mock_ai, mock_known_human, known_human"
    );
    eprintln!(
