...
define_feature_flags!(
    ...
    cloud_default_ai_attribution: cloud_default_ai_attribution, debug = false, release = false,
);
...
mod tests {
    ...
    fn test_default_feature_flags() {
        ...
        #[cfg(debug_assertions)]
        {
            ...
            assert!(!flags.cloud_default_ai_attribution);
        }
        #[cfg(not(debug_assertions))]
        {
            assert!(!flags.rewrite_stash);
    ...
    fn test_serialization() {
        ...
        assert!(serialized.contains("cloud_default_ai_attribution"));
    }
    ...
    fn test_clone_trait() {
        ...
        assert_eq!(
            cloned.cloud_default_ai_attribution,
            flags.cloud_default_ai_attribution
        );
    }
