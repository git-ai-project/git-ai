...
// Four daemon_captured_checkpoint_* tests removed: captured checkpoint
// functionality (PreparedCheckpointManifest, CapturedCheckpointRunRequest)
// was deleted in the checkpoint rewrite.
