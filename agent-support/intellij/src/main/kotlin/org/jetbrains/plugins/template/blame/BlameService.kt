...
class BlameService(private val project: Project) {
    ...
    companion object {
        ...
        fun getInstance(project: Project): BlameService =
            project.getService(BlameService::class.java)
    }
    ...
    private fun runBlame(filePath: String, content: String): BlameResult? {
        ...
        return try {
            ...
            val stdout = stdoutFuture.get(TIMEOUT_MS, TimeUnit.MILLISECONDS)
            val stderr = stderrFuture.get(TIMEOUT_MS, TimeUnit.MILLISECONDS)
