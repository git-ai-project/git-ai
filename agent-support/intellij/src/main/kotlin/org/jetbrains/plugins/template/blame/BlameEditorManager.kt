...
class BlameEditorManager(private val project: Project) : Disposable {
    ...
    companion object {
        ...
        fun getInstance(project: Project): BlameEditorManager = project.service()
    }
...
private class InlineBlameRenderer(
    ...
    override fun paint(inlay: Inlay<*>, g: Graphics2D, targetRegion: Rectangle, textAttributes: TextAttributes) {
        val editor = inlay.editor
        ...
        g.drawString(text, targetRegion.x + 4, y)
    }
